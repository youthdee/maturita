...
- Umožňuje dat mezi aplikacemi na různých zařízeních
...
- Na rozdíl od POP3 nabízí pokročilejší možnosti vzdálené správy (práce se složkami a přesouvání zpráv mezi nimi, prohledávání na straně serveru a podobně, práce v online a offline režimu)
...
- Definovaný protkol pro ukládání a přístup k datům na adresářovém serveru
...
- Prostřednictvím DHCP serveru nastavuje stanicím v lokální síti adresní parametry nutných pro komunikaci pomocí IP protokolu (IP adresa, maska podsítě, výchozí brána, DNS server)
...
- Síť řízená pomocí SNMP se skládá ze tří částí:
	...
	- NMS (Network Management Station) - Software, který běží na správcovských zařízeních
