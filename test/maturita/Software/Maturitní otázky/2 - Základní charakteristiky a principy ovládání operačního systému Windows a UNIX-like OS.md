...
- Dokumentace v /usr/share/doc
	- Zde je pro každá nástroj nainstalovaný v Linuxu jeden adresář, v němž se nachází užitečné informace, které nejsou v man pages, dále šablony a konfigurační soubory usnadňující konfiguraci
...
- GNU Info
	...
	- kromě nápovědy pro daný příkaz obsahují hypertextové odkazy pro navigaci mezi jednotlivými skecemi dokumentace
