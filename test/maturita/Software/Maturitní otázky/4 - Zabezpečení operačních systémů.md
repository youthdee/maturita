...
- Spouštějí se při spuštění počítače akontrolují systémové prostředky, disky a paměť na přitomnost malwaru
...
- Nejznámější techniky a nástroje sociálního inženýrství:
	...
	- Pretexting (získávání cizích osobních údajů pod falešnou zámínkou)
...
- Konstantě aktualizovaný dokument na bázi změn v technologie, biznisu a požadavků zaměstnanců
- Pravidla typu:
